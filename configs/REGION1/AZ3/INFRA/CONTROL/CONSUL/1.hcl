...
ca_file = "/vagrant/data/REGION1/AZ3/INFRA/CONTROL/CONSUL/ca.crt"
# certificate to be used by the server
cert_file = "/vagrant/data/REGION1/AZ3/INFRA/CONTROL/CONSUL/agent.crt"
# private key of server certificate
key_file = "/vagrant/data/REGION1/AZ3/INFRA/CONTROL/CONSUL/agent.key"
auto_encrypt {
  allow_tls = true
}
