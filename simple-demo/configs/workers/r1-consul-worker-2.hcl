...
data_dir = "/home/grays/Documents/repos/old/hashistack-multi-tenant-infrastructure-mockup/simple-demo/data/consul/R1/worker/2/"
# Just name of server that consul will register as, should be unique in each config when running multiple agents locally
node_name = "R1-nomad-consul-worker-2"
# set to make this agent not a server
server = false
# addresses to use for various interface settings
advertise_addr = "127.0.1.22"
client_addr    = "127.0.1.22"
