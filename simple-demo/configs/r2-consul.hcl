...
data_dir = "/home/grays/Documents/repos/old/hashistack-multi-tenant-infrastructure-mockup/simple-demo/data/consul/R2/"
# Just name of server that consul will register as, should be unique in each config when running multiple agents locally
node_name = "R2-nomad-consul-server"
...
advertise_addr = "127.0.1.12"
client_addr    = "127.0.1.12"
