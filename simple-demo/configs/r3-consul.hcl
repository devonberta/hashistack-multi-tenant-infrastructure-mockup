...
retry_join_wan = ["127.0.1.11:8302"]
# server specific data path value
data_dir = "/home/grays/Documents/repos/old/hashistack-multi-tenant-infrastructure-mockup/simple-demo/data/consul/R3/"
# Just name of server that consul will register as, should be unique in each config when running multiple agents locally
node_name = "R3-nomad-consul-server"
...
advertise_addr = "127.0.1.13"
client_addr    = "127.0.1.13"
